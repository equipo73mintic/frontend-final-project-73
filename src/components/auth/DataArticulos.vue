...
data: () => ({
  ...
  created () {
    this.list()
    this.poblateCategorias();
  },

  methods: {

    list(){
      axios.get('https://radiant-shore-56700.herokuapp.com/api/articulo/list')
      .then(response =>{
    ...
    save () {
      if (this.editedId > -1) {
        //PUT (update)
        axios.put('https://radiant-shore-56700.herokuapp.com/api/articulo/update', {
          id: this.editedId,
        ...
        //POST (add)
        axios.post('https://radiant-shore-56700.herokuapp.com/api/articulo/add', {
          nombre: this.editedItem.nombre,
          descripcion: this.editedItem.descripcion,
          codigo: this.editedItem.codigo,
          urlImage: this.editedItem.urlImage,
    ...
    confirmEditEstado(){
      if (this.editedItem.estado == 1){
        axios.put('https://radiant-shore-56700.herokuapp.com/api/articulo/deactivate', {
          id: this.editedId
        })
        .then(response =>{
          this.list();
        ...
        axios.put('https://radiant-shore-56700.herokuapp.com/api/articulo/activate', {
          id: this.editedId
        })
        .then(response =>{
          this.list();
